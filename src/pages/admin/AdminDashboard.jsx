...
const AdminDashboard = () => {
  ...
  const { getAllOrder, getAllProduct, getAllUser } = useContext(MyContext);
  return (
    <Layout>
      <div>
        {/* Top */}
        ...
        <div className="px-5">
          ...
          <div className="mid mb-5">
            {/* main  */}
            <div className=" bg-gray-200 py-5 rounded-xl border border-gray-100">
              {/* image  */}
            ...
            <Tabs>
              <TabList className="flex flex-wrap -m-4 text-center justify-center">
                ...
                <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                  <div className=" border bg-gray-200 hover:bg-gray-100 border-gray-100 px-4 py-3 rounded-xl">
