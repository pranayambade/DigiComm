...
const Category = () => {
  ...
  return (
    <div>
      <div className="flex select-none flex-col mt-5">
        {/* main 1 */}
              ...
              return (
                <div key={index} className="px-3 lg:px-10">
                  ...
                  <div
                    ...
                    className=" w-16 h-16 lg:w-24 lg:h-24 max-w-xs rounded-full  bg-yellow-200 transition-all hover:bg-yellow-300 hover:shadow-2xl cursor-pointer mb-1 "
                  >
